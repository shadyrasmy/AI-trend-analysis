// Fix: Create the Icons component module
...
export const Icons = {
  ...
  Rocket: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M5.1 18.9 3.2 17a2.8 2.8 0 0 1 0-4l11-11a2.8 2.8 0 0 1 4 0l1.9 1.9a2.8 2.8 0 0 1 0 4l-11 11a2.8 2.8 0 0 1-4 0Z"></path><path d="m17 7 5 5"></path><path d="M14 10a3 3 0 1 0-4-4"></path><path d="m18 11 2.5-2.5"></path><path d="m20 13 2.5-2.5"></path><path d="M5 19 2 22"></path></svg>
  ),
  ...
  Brain: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15A2.5 2.5 0 0 1 9.5 22h-2A2.5 2.5 0 0 1 5 19.5v-15A2.5 2.5 0 0 1 7.5 2h2z" /><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15A2.5 2.5 0 0 0 14.5 22h2a2.5 2.5 0 0 0 2.5-2.5v-15A2.5 2.5 0 0 0 16.5 2h-2z" /></svg>
  ),
  ...
  Puzzle: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14 7V4.5A2.5 2.5 0 0 0 11.5 2h-1A2.5 2.5 0 0 0 8 4.5V7" /><path d="M14 7h1.5A2.5 2.5 0 0 1 18 9.5v1A2.5 2.5 0 0 1 15.5 13H14" /><path d="M14 13v1.5A2.5 2.5 0 0 0 16.5 17h1a2.5 2.5 0 0 0 2.5-2.5V12" /><path d="M10 13H8.5A2.5 2.5 0 0 1 6 10.5v-1A2.5 2.5 0 0 1 8.5 7H10" /><path d="M10 13v1.5A2.5 2.5 0 0 0 7.5 17h-1A2.5 2.5 0 0 0 4 14.5V12" /><path d="M10 7V4.5A2.5 2.5 0 0 0 7.5 2h-1A2.5 2.5 0 0 0 4 4.5V7" /><path d="M10 7h4" /><path d="M14 13h-4" /><path d="M10 17v2.5A2.5 2.5 0 0 0 12.5 22h1A2.5 2.5 0 0 0 16 19.5V17" /></svg>
  ),
  Clock: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>
  ),
  UploadCloud: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 16l-4-4-4 4" /><line x1="12" y1="12" x2="12" y2="21" /><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3" /><path d="M16 16l-4-4-4 4" /></svg>
  ),
